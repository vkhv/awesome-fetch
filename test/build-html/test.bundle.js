(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("AwesomeFetch", [], factory);
	else if(typeof exports === 'object')
		exports["AwesomeFetch"] = factory();
	else
		root["AwesomeFetch"] = factory();
})(this, function() {
...
var _retriers = __webpack_require__(85);
...
var _promiseRetry = __webpack_require__(87);

var _promiseRetry2 = _interopRequireDefault(_promiseRetry);

var _get_request_options = __webpack_require__(84);
...
const json_fetch_1 = __webpack_require__(39);
class AwesomeFetch {
    json(url, options) {
...
function getRequestOptions(jsonFetchOptions) {
  ...
  var pickedOptions = (0, _lodash2.default)(jsonFetchOptions, ['agent', 'body', 'cache', 'credentials', 'headers', 'integrity', 'method', 'mode', 'redirect', 'referrer', 'referrerPolicy']);
...
var errcode = __webpack_require__(82);
var retry = __webpack_require__(90);
